...
#The preview step ensures clarity for the user, totally optional, and is primarily used to display the user's input in an organized way so they can review it before making predictions. It serves as a user-friendly feature but doesn't impact the functionality of the app.
...
# The preparation step ensures the data is ready for machine learning prediction. The input_data dictionary, is essential for the functionality of your app. It prepares the user-provided inputs in a structured format that can be passed to your trained model for making predictions.
